...
function appendMessage(role, content, usage = null) {
    ...
    if (role === 'assistant' && usage) {
        ...
        footer.innerHTML = `
            <div class="routing-hero-header">
                <span class="hero-title">ROUTING INTELLIGENCE</span>
                <span class="hero-id">ID: ${usage.id || 'N/A'}</span>
            </div>
            <div class="metrics-grid">
                <div class="metric-card accent-glow">
                    ...
                    <div class="metric-value-lg text-white">${model}</div>
                </div>
                <div class="metric-card">
                    ...
                    <div class="metric-value-lg text-indigo-300">${latency}ms</div>
                </div>
                <div class="metric-card">
                    <div class="metric-label">
                    ...
                    <div class="metric-value-lg text-emerald-400">${intent} <span class="text-xs opacity-50 ml-1 font-normal">(${confidence})</span></div>
                </div>
                <div class="metric-card">
                    <div class="metric-label">
                    ...
                    <div class="metric-value-lg text-purple-300">${reason}</div>
                </div>
            </div>
        `;
